        ...
        <div className="login-screen">
            <div className="login-container-box">
                <div className="login-box-left">
                    ...
                    <div className="mb-2">
                    <input type="password" className="form-control" name="password" placeholder="Password" id="password" tabIndex={2} autoComplete="off"
                        value={password} onChange={(e) => setPassword(e.target.value)}/>
                    </div>

                    <div className="links">
                        <span className="login-subtext">Don't have an Account? </span>
                        <NavLink className="logtoreg" to="/register">Register</NavLink>
